...
global.startRoom = rTut1;    //sets which room to begin with
...
global.pauseDelayLength = 4;   //sets the delay in frames in which the player can pause/unpause the game (can be set to 0 to disable pause delay)
